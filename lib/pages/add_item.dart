...
//       setState(() async {
//         _imageBytes = await pickedFile.readAsBytes();
//         _selectedFileName = null; // Clear the file name display
//       });
//     }
//   }
...
//     if (_selectedFileName != null && _imageBytes != null) {
//       return Container(
...
//                 ),
//               ),
//               _buildUploadedPhoto(), // Show uploaded photo
//               const SizedBox(height: 20),
//               SizedBox(
//                 width: 300,
//                 child: Column(
...
import 'package:firebase_storage/firebase_storage.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/services.dart'; // Import this for PlatformFile
import 'package:decla/pages/success_page.dart';
