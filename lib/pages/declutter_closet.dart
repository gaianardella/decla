...
// class _HomeScreenState extends State<HomeScreen> {
//   late Future<List<Map<String, String>>> upperImagesFuture;
//   late Future<List<Map<String, String>>> lowerImagesFuture;
//   late Future<List<Map<String, String>>> footwearImagesFuture;
...
//   void initState() {
//     super.initState();
//     // Initialize futures to fetch images from Firebase Storage
//     upperImagesFuture = fetchItemsFromFirebaseStorage('images/upper');
//     lowerImagesFuture = fetchItemsFromFirebaseStorage('images/lower');
//     footwearImagesFuture = fetchItemsFromFirebaseStorage('images/footwear');
//   }

//   Future<List<Map<String, String>>> fetchItemsFromFirebaseStorage(
//       String path) async {
...
//               future: upperImagesFuture, // Use the appropriate future
...
////////////////////////////////////////////////
///
/////FILTRO + ELIMINA DA FIREBASE MA NON DA UI
// import 'package:flutter/material.dart';
// import 'package:firebase_core/firebase_core.dart';
// import 'package:firebase_storage/firebase_storage.dart';
...
//   List<Map<String, String>> allItems = []; // List to hold all fetched items
//   List<Map<String, String>> filteredItems = []; // List to hold filtered items
...
//           'image': downloadURL,
//           'label': label,
//           'category': path.split('/').last, // Store category for filtering
//         });
//       }
//     } catch (e) {
//       print('Error fetching items from Firebase Storage: $e');
...
//   void _deleteItem(int index) async {
//     final String fullPath = filteredItems[index]['fullPath']!;
...
//                   Navigator.of(context).pop();
//                   setState(() {
//                     // Remove item from filteredItems list
//                     filteredItems.removeAt(index);
//                     // Also remove from allItems list to keep them in sync
//                     allItems
//                         .removeWhere((item) => item['fullPath'] == fullPath);
//                   });
//                 } catch (e) {
//                   print("Error deleting item: $e");
//                   // Handle deletion error (e.g., show error message)
...
//                   _buildFilterChip('All'),
//                   const SizedBox(width: 8),
//                   _buildFilterChip('upper'), // Corrected filter chip labels
//                   const SizedBox(width: 8),
//                   _buildFilterChip('lower'), // Corrected filter chip labels
//                   const SizedBox(width: 8),
//                   _buildFilterChip('footwear'), // Corrected filter chip labels
//                 ],
//               ),
//             ),
//           ),
...
//               future: Future.wait(
//                   [upperImagesFuture, lowerImagesFuture, footwearImagesFuture]),
//               builder: (context, snapshot) {
//                 if (snapshot.connectionState == ConnectionState.waiting) {
//                   return Center(child: CircularProgressIndicator());
//                 }
...
//                     snapshot.data as List<List<Map<String, String>>>;
//                 allItems.clear();
...
//                       .where((item) => item['category'] == _selectedChip)
//                       .toList();
//                 }
